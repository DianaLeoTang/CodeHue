...
- **React Hooks 精准着色**：支持 30+ React Hooks 的精准识别和着色
  ...
  - **ahooks 库支持**：支持 15+ ahooks 常用 Hooks（`useMemoizedFn`、`useDebounceFn`、`useAsyncEffect`、`useUpdateEffect`、`useBoolean`、`useDebounce`、`useLatest` 等）
...
### 🎯 智能识别
- **React Hooks 识别**：精准识别 30+ React Hooks
  - 核心 Hooks：`useState`、`useEffect`、`useMemo`、`useCallback`
  ...
  - **ahooks 库支持**：支持 15+ ahooks 常用 Hooks
    - 状态管理：`useSetState`、`useBoolean`、`useGetState`
    - 副作用增强：`useAsyncEffect`、`useUpdateEffect`、`useDebounceEffect`、`useTrackedEffect`、`useDeepCompareEffect`
    - 函数优化：`useMemoizedFn`、`useDebounceFn`、`useDebounce`
    - 工具 Hooks：`useLatest`、`useUpdate`、`useUnmount`、`useEventEmitter`
...
- **Vue 单文件组件完整支持**：完整的 Vue SFC 解析和着色
  ...
  - Vant 组件库高频组件识别
- **智能识别**：精准识别 30+ React Hooks（包括 React 内置 Hooks 和 ahooks 库 Hooks），智能过滤不需要着色的代码
...
4. **React Hooks 识别**：30+ React Hooks 会自动着色和注释
   - 核心 Hooks：`useState`、`useEffect`、`useMemo`、`useCallback`
   - 扩展 Hooks：`useRef`、`useContext`、`useReducer`、`useLayoutEffect` 等
   - 并发特性 Hooks：`useDeferredValue`、`useTransition`、`useId` 等
   - **ahooks 库支持**：支持 15+ ahooks 常用 Hooks，包括 `useMemoizedFn`、`useDebounceFn`、`useAsyncEffect`、`useBoolean`、`useDebounce`、`useLatest` 等
